      ...
      <DialogContent className="max-w-5xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-3xl font-bold bg-gradient-primary bg-clip-text text-transparent">
            {!showResources ? "Select Your Finance Service" : selectedService}
          </DialogTitle>
          <DialogDescription className="text-base">
            {!showResources 
              ? "Choose the financial service category that best matches your needs"
              : "Upload documents, download templates, or connect your ERP before chatting with Freddy"
            }
          </DialogDescription>
        </DialogHeader>
